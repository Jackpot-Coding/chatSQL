...
\begin{flushleft}
	\begin{spacing}{1.5}
		REDATTORE: G. Moretto, M. Gobbo, E. Gallo, R. Simionato\\%INSERT HERE THE NAMES
		VERIFICATORI: G. Moretto, M. Gobbo, E. Gallo, R. Simionato\\
	\end{spacing}
\end{flushleft}
...
\begin{longtblr}
    ...
    % \hline
    V1.0.2 & 18/03/2024 & E. Gallo & - & Modifica al Registro delle modifiche\\
    \hline

...
\centerline{%
  \begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    V0.1.1 & 3/03/2024 & R. Simionato & M. Gobbo & \shortstack{Aggiunto corsivo per i termini in inglese\\e apice G per Glossario} \\
    \hline
    V0.1.0 & 2/03/2024 & - & R. Simionato & Verifica documento \\
    \hline
    V0.0.10 & 10/02/2024 & M. Gobbo & R. Simionato & \shortstack{Stesura della sezione 4.3 Formazione} \\
    \hline
    V0.0.9 & 12/01/2024 & M. Camillo & R. Simionato & \shortstack{Stesura della sezione 4.1 Gestione di processo } \\
    \hline
    V0.0.8 & 06/01/2024 & M. Gobbo & R. Simionato & \shortstack{Stesura parte 2.1, stesura iniziale parte 2.2 } \\
    \hline
    V0.0.7 & 04/01/2024 & M. Gobbo & R. Simionato & \shortstack{Stesura parte 1.4, stesura iniziale parte 3.2, 3.3, 3.4} \\
    \hline
    V0.0.6 & 28/11/2023 & E. Gallo & R. Simionato & \shortstack{Stesura delle sezioni 1.1, 1.2, 1.3 \\ dell'Introduzione} \\
    \hline
    V0.0.5 & 27/11/2023 & G.Moretto & R. Simionato & \shortstack{Aggiornamento sezioni da 3.1.8 a 3.1.12 } \\
    \hline
    V0.0.4 & 19/11/2023 & G.Moretto & R. Simionato & \shortstack{Aggiunti \textit{link} all'indice \\ Aggiornamento sezioni 3.1.4, 3.1.5,\\ 3.1.6 , 3.1.7} \\
    \hline
    V0.0.3 & 17/11/2023 & R.Simionato & G.Moretto & Aggiunta sezione 4.2 Infrastruttura \\
    \hline
    V0.0.2 & 16/11/2023 & G. Moretto & R. Simionato & \shortstack{Aggiunta sezione 3.1 documentazione \\ e stesura preliminare} \\
    \hline
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Le corrispondenti \textit{issue} vengono inserite su \textit{GitHub}.
    \end{itemize}
...
\begin{itemize} 
    ...
    \item\textbf{\textit{In Progress}}: la \textit{issue} è in lavorazione. Potrà essere spostata alla lista "\textit{Done}", solamente quando verrà terminata e verificata;

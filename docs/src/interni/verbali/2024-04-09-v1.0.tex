...
\begin{flushleft}
    \begin{spacing}{1.5}
        REDATTORE:  M. Gobbo\\%INSERT HERE THE NAMES
...
Abbiamo quindi scritto al Professor Cardin per avere un parere sul nostro operato.\\
Abbiamo inoltre scritto all'azienda proponente "Zucchetti" per tenerla aggiornata del nostro lavoro e, come da consiglio post RTB, dialogarci maggiormente
\section{DECISIONI}
\begin{itemize}

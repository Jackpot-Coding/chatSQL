...
\begin{document}
    ...
    \section{Istruzioni all'uso}
	    ...
	    \begin{figure}[ht]
	    	\centering
	    	\fbox{\includegraphics[width = 0.5\textwidth]{User_Manual/prompt_result.png}}
	    ...
	    \begin{figure}[h]
	    	\centering
	    	\fbox{\includegraphics[width = 0.5\textwidth]{User_Manual/structure_view.png}}
	    ...
	    \begin{figure}[ht]
	    	\centering
	    	\fbox{\includegraphics[width = 0.5\textwidth]{User_Manual/new_structure_form.png}}

...
\begin{longtblr}
    ...
    % \hline
    v2.0.0 & 22/05/2024 & - & M. Gobbo & Verifica documento per versione 2.0.0 \\
    \hline
    v1.0.4 & 07/05/2024 & G. Moretto & M. Gobbo & Correzione code coverage e rimozione tempo di apprendimento e risposta \\
    \hline
    v1.0.3 & 25/04/2024 & R. Simionato & G. Moretto & Aggiunte definizioni dal documento "Specifica Tecnica" \\
    \hline
    v1.0.2 & 25/04/2024 & R. Simionato & G. Moretto & Aggiunte definizioni metriche dal documento "Piano di Qualifica" \\
    \hline
    v1.0.1 & 04/04/2024 & G. Moretto & R. Simionato & Rimozione Redattori e Verificatori come da feedback RTB\\
    \hline
...
\addcontentsline{toc}{subsection}{Code Coverage}
\textbf{\textit{Code Coverage}}: Metrica che misura la percentuale di codice che viene eseguito durante i test.\newline

...
\begin{itemize}
	...
	\item \textbf{Postcondizioni:} 
	\begin{itemize}
		\item L'amministratore può vedere nome, descrizione e sinonimi delle tabelle presenti;
	\end{itemize}
	\item \textbf{Scenario principale:} 
	\begin{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item \hyperref[sec:UC14.1]{\textbf{UC14.1}} - Errore mancato inserimento sinonimi campo
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item L’amministratore ha effettuato il login (\hyperref[sec:UC1]{\textbf{UC1}});
		\item L’amministratore sta creando un nuovo campo (\hyperref[sec:UC13]{\textbf{UC13}});
	\end{itemize}
	\item \textbf{Postcondizioni:} 
	\begin{itemize}

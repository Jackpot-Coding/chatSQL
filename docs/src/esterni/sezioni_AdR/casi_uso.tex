...
\label{sec:UC11}
\includegraphics[scale=0.6]{UML_Use_Cases/UC11_13_14.png}
\begin{itemize}
...
\subsection{UC12 - Visualizzazione lista delle tabelle nella Struttura Database}
\label{sec:UC12}
\includegraphics[scale=0.6]{UML_Use_Cases/UC12.png}
\begin{itemize}

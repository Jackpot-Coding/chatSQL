...
\subsection{UC25.2 - Errore Struttura \textit{Database}\textsuperscript{G} non selezionata}
\label{sec:UC25.2}
\begin{itemize}
...
\subsection{UC25.3 - Inserimento frase in linguaggio naturale\textsuperscript{G}}
\label{sec:UC25.3}
...
\subsection{UC25.4 - Errore frase naturale}
\label{sec:UC25.4}
\begin{itemize}
...
\subsection{UC25.5 - Visualizzazione \textit{prompt\textsuperscript{G}} generato}
\label{sec:UC25.5}
...
\subsection{UC26 - Errore generazione \textit{prompt\textsuperscript{G}}}
\label{sec:UC26}
\begin{itemize}
...
\subsubsection{UC26.2 - Errore dati mancanti per creazione \textit{prompt\textsuperscript{G}}}
\label{sec:UC26.2}
\begin{itemize}
...
\subsection{UC27 - Richiesta generazione \textit{query SQL}\textsuperscript{G}}
\label{sec:UC27}
...
\subsection{UC28 - Errore generazione \textit{query SQL\textsuperscript{G}}}
\label{sec:UC28}
%   \includegraphics[]{diagramma_UML}
\begin{itemize}
...
\subsubsection{UC28.1 - Errore comunicazione con API\textsuperscript{G}}
\label{sec:UC28.1}
...
\subsubsection{UC28.2 - Errore formattazione \textit{prompt\textsuperscript{G}}}
\label{sec:UC28.2}
\begin{itemize}
...
\subsection{UC29 - Visualizzazione \textit{query SQL\textsuperscript{G}}}
\label{sec:UC29}
\begin{itemize}

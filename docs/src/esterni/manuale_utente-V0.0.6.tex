			...
			\begin{table}[H]
				...
				\resizebox{\linewidth}{!}{
					\begin{tabular}{|c|c|c|c|c|c|c|c|}
						...
						python3 & 3.1 & \hyperref[Download Python]{https://www.python.org/downloads/} \\ \hline
						django & 5.0 & \hyperref[Download Django]{https://www.djangoproject.com/} \\ \hline
						torch & 2.3 & \hyperref[Download Torch]{https://pypi.org/project/torch/} \\ \hline
						transformers & 4.40 & \hyperref[Download Transformers]{https://pypi.org/project/transformers/} \\ \hline
						llmstudio & 0.2 & \hyperref[Download LLMStudio]{https://lmstudio.ai/} \\ \hline
						Browser & 124 o superiori & Verranno mostrati in dettaglio nella tabella successiva \\ \hline
					\end{tabular}
				}
			...
			\begin{table}[H]
				...
				\resizebox{\linewidth}{!}{
					\begin{tabular}{|c|c|c|c|c|c|c|c|}
						...
						Chrome & 124 & \hyperref[Download Chrome]{https://www.google.it/intl/it/chrome/} \\ \hline        
						Edge & 124 & \hyperref[Download Edge]{https://www.microsoft.com/it-it/edge/download} \\ \hline
						Firefox & 125 & \hyperref[Download Firefox]{https://www.mozilla.org/it/firefox/new/} \\ \hline
						Opera & 110 & \hyperref[Download Opera]{https://www.opera.com/}\\ \hline
					\end{tabular}
				}

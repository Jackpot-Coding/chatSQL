...
\centerline{%
  \begin{tabular}{|c|c|c|c|c|}
    ...
    % \hline\\
    v.0.1.2 & 12/02/2024 & G.Moretto & - & \shortstack{Aggiunti Tabella, Campi e Sinonimi  al glossario,\\ correzione terminologia casi d'uso}\\
    \hline
    v.0.1.1 & 12/02/2024 & G.Moretto & - & Aggiunti riferimenti al Glossario \\
    \hline

...
\begin{document}
	...
	\begin{table}[ht]
		\centerline{%
			\begin{tabular}{|c|c|c|c|c|}
                \hline
                v.0.1.3 & 17/03/2024 & M. Gobbo & - & Aggiunta Sezione 3 -Qualità di Prodotto \\
				\hline
				v.0.1.2 & 17/03/2024 & R. Simionato & - & Aggiunta struttura Sezione 3-Qualità di Prodotto \\
				\hline
				v.0.1.1 & 16/03/2024 & R. Simionato & - & \shortstack{Prima stesura sezione Qualità di Processo\\e inserimento tabelle} \\
				\hline
	...
	\begin{longtblr}
		...
		Funzionalità & La capacità del prodotto software di soddisfare 
            i requisiti trovati e descritti all’interno dell’Analisi dei Requisiti V.1.0.0. & MPD - CR \\
		\hline
		...
		\hline
		Manutenibilità & La caoacità del software ad essere incline a 
            modifiche, miglioramenti in corso d'opera & MPD - CC \\
		\hline
		Portabilità & La capacità del softwarer di poter essre utilizzato 

...
\begin{document}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot+[sharp plot, blue] coordinates { (0,-1.18) (1,-4.6) (2,-1.1) };
...
\pgfplotsset{compat=1.11}
	\begin{tikzpicture}
		\begin{axis}[
				xticklabels={S.1-2, S.3-4, S.5-6, S.7-8, S.9-10, S.11-12, S.13-14, S.15, S.16, 1, 2},
			...
			\addplot+[sharp plot, red4, mark options={fill=red4}] coordinates { 
				(0,190) (1,430) (2,705) (3,1025) (4,1562) (5,1797.5) (6,2062.5)
				(7,2282.5) (8,2542.5) (9,2780) (10,2977.5) 
			 };
			\addlegendentry{Actual Cost}
			
			\addplot+[sharp plot, teal6,mark=*,mark options={fill=teal6}] coordinates {
				(0,10850) (1,10610) (2,10335) (3,10015) (4,9477.5) (5,9242.5) (6,8977.5)
				(7,8757.5) (8,8497.5) (9,8260) (10,8062.5)
			 };
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot+[sharp plot, blue] coordinates {(0,18) (1,-1) (2,-22) };

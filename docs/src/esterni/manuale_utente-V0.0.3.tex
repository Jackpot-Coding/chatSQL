	...
	\begin{table}[ht]
		\centerline{%
			\begin{tabular}{|c|c|c|c|c|}
                \hline
				v.0.0.3 & 05/04/2024 & M. Gobbo & - & Prima Stesura sezione 1 \\
                \hline
...
Lo scopo del documento "Manuale Utente" è quello di mostrare le istruzioni per l'uso e le funzionalità inerenti al prodotto. Grazie a questo l'utente sarà a conoscenza dei requisiti minimi necessari per il corretto funzionamento di "Chat SQL" e di come installarla in locale.

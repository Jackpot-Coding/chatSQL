...
urlpatterns = [
   ...
   path('tabella/<int:table_id>/campo/nuovo',login_required(views.AdminCampoTabellaView.as_view(),login_url="/admin/login"),
        name="new_campo_view"),
   path('campo/<int:field_id>',login_required(views.AdminCampoTabellaView.as_view(),login_url="/admin/login"),
        name="campo_view")
]

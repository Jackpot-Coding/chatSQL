...
class PromptView(View):
    def get(self,request):
        ...
        return render(request,"prompt.html", {"natural_lang_form":natural_lang_form})
    ...
    def post(self,request):
        ...
        return render(request,"prompt.html",  {"natural_lang_form":natural_lang_form, "prompt_form":promt[1]})